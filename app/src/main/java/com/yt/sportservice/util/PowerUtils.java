...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
    ...
    public void wakeupScreen(long wakeupTime){
        PowerManager powerManager = (PowerManager) (KApplication.sContext.getSystemService(KApplication.sContext.POWER_SERVICE));
        PowerManager.WakeLock wakeLock = null;
        wakeLock = powerManager.newWakeLock(PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP
                | PowerManager.ON_AFTER_RELEASE, "new_message_lock");
